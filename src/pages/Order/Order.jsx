...
class Order extends Component {
    ...
    onSubmitClick = (event) => {
        ...
        const productList =  Object.fromEntries(new Map(JSON.parse(localStorage.getItem("products"))));
        ...
        const orderData = {customerFirstName, customerLastName, customerEmail, country, city, street, postcode, building,
            room, paymentMethod, shippingType, status, total, productList};
                            ...
                            <div className="container-fluid">
                                <div className="row">
                                    {products.map((product) => {
                                        return (
                                            <div key={product.productId} className="col-lg-6 d-flex align-items-stretch">
                                                <div className="card mb-5">
                                                    ...
                                                    <div className="card-body text-center">
                                                        ...
                                                        <h6><span>Quantity: {productsInCart.get(product.productId)}</span></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        );
